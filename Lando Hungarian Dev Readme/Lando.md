...
* [Landofile írása](#landofile--r-sa)
  + [Magyarázat](#magyar-zat)
  + [Alap környezet](#alap-k-rnyezet)
  + [Egyéni PHP beállítások az appserverhez](#egy-ni-php-be-ll-t-sok-az-appserverhez)
  + [Másik fajta adatbázis-szerver beállítása](#m-sik-fajta-adatb-zis-szerver-be-ll-t-sa)
  + [MySQL/MariaDB slow query log bekapcsolása](#mysql-mariadb-slow-query-log-bekapcsol-sa)
  + [phpMyAdmin hozzáadása](#phpmyadmin-hozz-ad-sa)
  + [Drush útvonalának manuális megadása](#drush--tvonal-nak-manu-lis-megad-sa)
  + [NodeJS 10 Gulppal hozzáadása](#nodejs-10-gulppal-hozz-ad-sa)
  + [Apache Solr hozzáadása](#apache-solr-hozz-ad-sa)
    - [Ha csak most adod hozzá](#ha-csak-most-adod-hozz-)
    - [Ha már vannak solr core fájlok (amit a + Get config.zip gombbal töltöttél le a Drupalban a Solr Server beállításakor)](#ha-m-r-vannak-solr-core-f-jlok--amit-a---get-configzip-gombbal-t-lt-tt-l-le-a-drupalban-a-solr-server-be-ll-t-sakor-)
  + [Varnish hozzáadása](#varnish-hozz-ad-sa)
  + [Redis hozzáadása](#redis-hozz-ad-sa)
  + [Webpack NodeJS 16 Vue CLI-vel](#webpack-nodejs-16-vue-cli-vel)
  + [xdebug PHP extension hozzáadása az appserverhez](#xdebug-php-extension-hozz-ad-sa-az-appserverhez)
    - [1. Alap beállítás](#1-alap-be-ll-t-s)
    - [2. Windows esetén](#2-windows-eset-n)
      * [2.1 Windows-on futtatott phpStorm esetén további szükséges beállítás](#21-windows-on-futtatott-phpstorm-eset-n-tov-bbi-sz-ks-ges-be-ll-t-s)
      * [2.2 WSL2 alatt futtatjuk a phpStormot](#22-wsl2-alatt-futtatjuk-a-phpstormot)
    - [3. phpStorm beállítása debugolásra](#3-phpstorm-be-ll-t-sa-debugol-sra)
    - [4. Használat](#4-haszn-lat)
  + [Új PHP extension hozzáadása az appserverhez](#-j-php-extension-hozz-ad-sa-az-appserverhez)
  + [wkhtmltopdf telepítése az appserverbe](#wkhtmltopdf-telep-t-se-az-appserverbe)
  + [Portok megnyitása a konténerben futtatott szerverekre](#portok-megnyit-sa-a-kont-nerben-futtatott-szerverekre)
  + [PHP codestyle check hozzáadása](#php-codestyle-check-hozz-ad-sa)
  + [Lokális szerverek elérése másik gépről vagy mobilról](#lok-lis-szerverek-el-r-se-m-sik-g-pr-l-vagy-mobilr-l)
    - [Beállítás](#be-ll-t-s)
    - [Használat](#haszn-lat)
  + [Hibás konténerek újraépítése](#hib-s-kont-nerek--jra-p-t-se)
  + [Drupal PHPUnit tesztek futtatása](#drupal-phpunit-tesztek-futtat-sa)
    - [Beállítás](#be-ll-t-s-1)
    - [Használat](#haszn-lat-1)
  + [Google Cloud SDK Landoval](#google-cloud-sdk-landoval)
    - [Beállítás](#be-ll-t-s-2)
    - [Használat](#haszn-lat-2)
  + [Amazon Web Services CLI Landoval](#amazon-web-services-cli-landoval)
    - [Beállítás](#be-ll-t-s-3)
    - [Használat](#haszn-lat-3)
